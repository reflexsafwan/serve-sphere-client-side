...
const Navbar = () => {
  ...
  const links = (
    <>
      <NavLink
        className={({ isActive }) =>
          isActive
            ? "bg-[#ED4C67] text-white px-3 py-2 rounded-lg text-base "
            : "hover:bg-[#ED4C67] hover:text-white px-3 py-2 rounded-lg text-base "
        }
        to={"/"}
      >
        Home
  ...
  return (
    <>
      <div className="navbar bg-base-100 shadow-sm  mx-auto mt-4">
